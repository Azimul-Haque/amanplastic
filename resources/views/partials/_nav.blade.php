...
<div class="offcanvas-container" id="mobile-menu">
    ...
    <div class="user-info">
      <h6 class="user-name">Aman Plastic Industries</h6><span class="text-sm text-white opacity-60">290 Reward points</span>
    </div></a>
  <nav class="offcanvas-menu">
    <ul class="menu">
...
<header class="navbar navbar-sticky">
  ...
  <div class="site-branding">
    <div class="inner">
      ...
      <!-- Site Logo-->
      <a class="site-logo" href="{{ route('index.index') }}">
        <table>
          <tr>
            <td>
              <img src="{{ asset('images/logo.png') }}" alt="Logo" style="max-height: 65px; width: auto;">
            </td>
            <td>
              <h3 class="hidden-md-down">Aman Plastic Industries</h3>
            </td>
          </tr>
        </table>
      </a>
